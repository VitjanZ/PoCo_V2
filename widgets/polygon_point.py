...
class PolygonPointItem(QGraphicsItem):
    ...
    def handle_removal_event(self, removal_from_undo=False):
        self.curr_scene.annotation_manager.roi_points[self.curr_scene.image_name].remove((self.x, self.y))
        self.curr_scene.roi_point_items.remove(self)
        self.curr_scene.removeItem(self)
        self.curr_scene.draw_roi_polygon()
